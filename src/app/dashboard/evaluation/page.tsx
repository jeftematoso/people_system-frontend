    ...
    <table className="w-full">
      ...
      <thead>
        <tr className="border-b">
          <th className="text-left pb-4">Aprendiz</th>
          <th className="text-left pb-4">Comunicação</th>
          <th className="text-left pb-4">Comportamento</th>
          <th className="text-left pb-4">Frequência</th>
          <th className="text-left pb-4">Desempenho</th>
          <th className="text-left pb-4">Média</th>
          <th className="text-left pb-4">Comentários</th>
